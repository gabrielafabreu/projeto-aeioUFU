...
export default function App() {
  ...
  const selecionaLetra = async(x) => {
    ...
    if(i < 36){
      ...
      return navigation.navigate("LetrasExemplos");
    }
  ...
  const avaliar = async() => {
      ...
      await AsyncStorage.setItem('nivel', "1");
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.titulo}> Letras e Números</Text>
    ...
    <ScrollView>
      ...
      <Modal
        ...
        <View style={styles.modalStyle}>
            ...
            <Text style={styles.tituloModal}>NÍVEL 1 CONCLUÍDO</Text>
