...
export default function App() {
  ...
  const verificado = async() => {
    ...
    for (let letra of letras) {
      ...
      let progresso = await AsyncStorage.getItem(`progresso_silaba_${letra}`);
  ...
  const selecionaLetra = async(x) => {
    ...
    if(verificado()){  
      ...
      await AsyncStorage.setItem('silaba', x);
      await AsyncStorage.setItem(`progresso_silaba_${x}`, 'acessado');
      ...
      return navigation.navigate("SilabasExemplos");
    }
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.titulo}>Sílabas</Text>
