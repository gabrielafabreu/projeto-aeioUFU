...
export default function App() {
  ...
  const verificado = async() => {
    ...
    for (let letra of letras) {
      ...
      let progresso = await AsyncStorage.getItem(`progresso_historia_${letra}`);
  ...
  const selecionaLetra = async(x) => {
    ...
    if(verificado()){  
      ...
      await AsyncStorage.setItem(`progresso_historia_${x}`, 'acessado');
      ...
      // return navigation.navigate("HistoriasExemplos");
    }
    ...
    const avaliar = async() => {
        ...
        await AsyncStorage.setItem('nivel', "5");
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.titulo}>Histórias</Text>
    ...
    <Modal
        ...
        <View style={styles.modalStyle}>
            ...
            <Text style={styles.tituloModal}>NÍVEL 5 CONCLUÍDO</Text>
